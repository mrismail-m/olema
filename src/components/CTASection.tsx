        ...
        >
          ...
          >
            ...
            <div
              ...
              style={{
                borderColor: isButtonHovered ? "var(--secondary, #c1ff72)" : "rgba(255, 255, 255, 0.2)",
                backgroundColor: isButtonHovered ? "var(--secondary, #c1ff72)" : "transparent",
                boxShadow: isButtonHovered ? "0 0 30px rgba(193, 255, 114, 0.35)" : "none",
              }}
            >
              <Calendar
                ...
                strokeWidth={1.5}
                style={{
                  color: isButtonHovered ? "#0d1b20" : "#ffffff",
                }}
              />
              <span
          ...
          <div className={styles.headingFlex}>
            ...
            <div className={styles.circleBtnContainer}>
              <div
                ...
                style={{
                  borderColor: isClicked ? "#ffffff" : isHovered ? "var(--secondary, #c1ff72)" : "rgba(255, 255, 255, 0.25)",
                  backgroundColor: isClicked ? "transparent" : isHovered ? "var(--secondary, #c1ff72)" : "transparent",
                ...
                style={{
                  transform: isClicked
                    ...
                    : isHovered
                      ...
                      : "translate(0, 0)",
                  opacity: isClicked ? 0 : 1,
                  color: isHovered && !isClicked ? "#0d1b20" : "#ffffff",
